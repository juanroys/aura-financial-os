...
import { Target, Users, Search, SlidersHorizontal, ChevronDown, ChevronUp, Star, Eye } from 'lucide-react';
    ...
    <div className="flex flex-col relative w-full font-jakarta">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] text-gray-300 font-semibold md:hidden">
            {isCollapsed ? '(Toca para expandir)' : '(Toca para colapsar)'}
          </span>
        </div>

        <div className="flex items-center gap-2">
          <button 
            onClick={(e) => { e.stopPropagation(); alert('Ajustes de Guías Inteligentes AURA'); }}
      ...
      {/* White Card Body (Collapsible on Mobile) */}
      {!isCollapsed && (
        <div className="interlock-white-body pt-6 space-y-4 animate-fadeIn">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              {showSearchInput ? (
                ...
                <button 
                  ...
                  className="w-9 h-9 rounded-full border border-gray-300/80 bg-transparent text-gray-700 flex items-center justify-center hover:bg-gray-100 transition-all shadow-2xs"
                  title="Buscar"
                >
                  <Search className="w-4 h-4 text-gray-600 stroke-[1.75]" />
                </button>
              )}
              ...
              <button 
                ...
                className={`w-9 h-9 rounded-full border border-gray-300/80 bg-transparent flex items-center justify-center transition-all shadow-2xs ${
              ...
              <div className="relative">
                <button 
                  ...
                  className="px-4 py-2 rounded-full border border-gray-300/80 bg-transparent text-[#101217] font-jakarta font-bold text-xs flex items-center gap-1.5 hover:bg-gray-100 transition-all shadow-2xs"
                >
                  <span>Related</span>
                ...
                {showRelatedDropdown && (
                  <div className="absolute right-0 top-10 z-30 w-44 bg-white rounded-2xl shadow-xl border border-gray-200 p-2 text-xs font-medium space-y-1 animate-fadeIn">
                    <button 
